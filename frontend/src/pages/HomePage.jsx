    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero__summit-motif" aria-hidden="true">
          <div className="hero__summit-motif-contours" />
          <svg
            viewBox="0 0 440 500"
            fill="none"
          ...
          >
            ...
            <g filter="url(#heroSummitGlow)">
              <path
                ...
                d="M176,120 C195,148 233,168 255,195 C228,228 178,250 152,270 C138,298 195,328 232,345 C258,378 198,408 185,432 "
              />

              <circle className="hero__summit-motif-node" cx="176" cy="120" r="7" />
              <circle className="hero__summit-motif-node" cx="255" cy="195" r="6.5" />
              <circle className="hero__summit-motif-node" cx="152" cy="270" r="6.5" />
              <circle className="hero__summit-motif-node" cx="232" cy="345" r="6.5" />
              <circle className="hero__summit-motif-node" cx="185" cy="432" r="6.5" />

              <path
                className="hero__summit-motif-pin"
                d="M180.0,38.0 C191.0,38.0 200.0,47.0 200.0,58.0 C200.0,72.0 186.0,85.0 180.0,92.0 C174.0,85.0 160.0,72.0 160.0,58.0 C160.0,47.0 169.0,38.0 180.0,38.0 Z"
              />
              <circle className="hero__summit-motif-pin-core" cx="180.0" cy="58.0" r="5.5" />
            </g>
          </svg>
        </div>
